...
\f\r"'\`<>=]|("|')|))|$)`,"g"),jn=/'/g,Wn=/"/g,Bn=/^(?:script|style|textarea|title)$/i,Ft=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),a=Ft(1),ia=Ft(2),aa=Ft(3),oe=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),Hn=new WeakMap,te=ne.createTreeWalker(ne,129);function On(e,t){if(!Ut(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return An!==void 0?An.createHTML(t):t}var Dn=(e,t)=>{let n=e.length-1,o=[],s,i=t===2?"<svg>":t===3?"<math>":"",d=Ce;for(let u=0;u<n;u++){let p=e[u],f,v,m=-1,N=0;for(;N<p.length&&(d.lastIndex=N,v=d.exec(p),v!==null);)N=d.lastIndex,d===Ce?v[1]==="!--"?d=En:v[1]!==void 0?d=Pn:v[2]!==void 0?(Bn.test(v[2])&&(s=RegExp("</"+v[2],"g")),d=ee):v[3]!==void 0&&(d=ee):d===ee?v[0]===">"?(d=s??Ce,m=-1):v[1]===void 0?m=-2:(m=d.lastIndex-v[2].length,f=v[1],d=v[3]===void 0?ee:v[3]==='"'?Wn:jn):d===Wn||d===jn?d=ee:d===En||d===Pn?d=Ce:(d=ee,s=void 0);let z=d===ee&&e[u+1].startsWith("/>")?" ":"";i+=d===Ce?p+kr:m>=0?(o.push(f),p.slice(0,m)+Mt+p.slice(m)+U+z):p+U+(m===-2?u:z)}return[On(e,i+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),o]},Pe=class e{constructor({strings:t,_$litType$:n},o){let s;this.parts=[];let i=0,d=0,u=t.length-1,p=this.parts,[f,v]=Dn(t,n);if(this.el=e.createElement(f,o),te.currentNode=this.el.content,n===2||n===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=te.nextNode())!==null&&p.length<u;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith(Mt)){let N=v[d++],z=s.getAttribute(m).split(U),Ie=/([.?@])?(.*)/.exec(N);p.push({type:1,index:i,name:Ie[2],strings:z,ctor:Ie[1]==="."?Ke:Ie[1]==="?"?Ge:Ie[1]==="@"?Ve:se}),s.removeAttribute(m)}else m.startsWith(U)&&(p.push({type:6,index:i}),s.removeAttribute(m));if(Bn.test(s.tagName)){let m=s.textContent.split(U),N=m.length-1;if(N>0){s.textContent=ze?ze.emptyScript:"";for(let z=0;z<N;z++)s.append(m[z],Ae()),te.nextNode(),p.push({type:2,index:++i});s.append(m[N],Ae())}}}else if(s.nodeType===8)if(s.data===Nt)p.push({type:2,index:i});else{let m=-1;for(;(m=s.data.indexOf(U,m+1))!==-1;)p.push({type:7,index:i}),m+=U.length-1}i++}}static createElement(t,n){let o=ne.createElement("template");return o.innerHTML=t,o}};function re(e,t,n=e,o){if(t===oe)return t;let s=o!==void 0?n._$Co?.[o]:n._$Cl,i=Ee(t)?void 0:t._$litDirective$;return s?.constructor!==i&&(s?._$AO?.(!1),i===void 0?s=void 0:(s=new i(e),s._$AT(e,n,o)),o!==void 0?(n._$Co??=[])[o]=s:n._$Cl=s),s!==void 0&&(t=re(e,s._$AS(e,t.values),s,o)),t}var qe=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:o}=this._$AD,s=(t?.creationScope??ne).importNode(n,!0);te.currentNode=s;let i=te.nextNode(),d=0,u=0,p=o[0];for(;p!==void 0;){if(d===p.index){let f;p.type===2?f=new ue(i,i.nextSibling,this,t):p.type===1?f=new p.ctor(i,p.name,p.strings,this,t):p.type===6&&(f=new Ye(i,this,t)),this._$AV.push(f),p=o[++u]}d!==p?.index&&(i=te.nextNode(),d++)}return te.currentNode=ne,s}p(t){let n=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,n),n+=o.strings.length-2):o._$AI(t[n])),n++}},ue=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,o,s){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=o,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=re(this,t,n),Ee(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==oe&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ln(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&Ee(this._$AH)?this._$AA.nextSibling.data=t:this.T(ne.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Pe.createElement(On(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===s)this._$AH.p(n);else{let i=new qe(s,this),d=i.u(this.options);i.p(n),this.T(d),this._$AH=i}}_$AC(t){let n=Hn.get(t.strings);return n===void 0&&Hn.set(t.strings,n=new Pe(t)),n}k(t){Ut(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,o,s=0;for(let i of t)s===n.length?n.push(o=new e(this.O(Ae()),this.O(Ae()),this,this.options)):o=n[s],o._$AI(i),s++;s<n.length&&(this._$AR(o&&o._$AB.nextSibling,s),n.length=s)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let o=Cn(t).nextSibling;Cn(t).remove(),t=o}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},se=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,o,s,i){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=n,this._$AM=s,this.options=i,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=c}_$AI(t,n=this,o,s){let i=this.strings,d=!1;if(i===void 0)t=re(this,t,n,0),d=!Ee(t)||t!==this._$AH&&t!==oe,d&&(this._$AH=t);else{let u=t,p,f;for(t=i[0],p=0;p<i.length-1;p++)f=re(this,u[o+p],n,p),f===oe&&(f=this._$AH[p]),d||=!Ee(f)||f!==this._$AH[p],f===c?t=c:t!==c&&(t+=(f??"")+i[p+1]),this._$AH[p]=f}d&&!s&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Ke=class extends se{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}},Ge=class extends se{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}},Ve=class extends se{constructor(t,n,o,s,i){super(t,n,o,s,i),this.type=5}_$AI(t,n=this){if((t=re(this,t,n,0)??c)===oe)return;let o=this._$AH,s=t===c&&o!==c||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,i=t!==c&&(o===c||s);s&&this.element.removeEventListener(this.name,this,o),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Ye=class{constructor(t,n,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){re(this,t)}},Jn={M:Mt,P:U,A:Nt,C:1,L:Dn,R:qe,D:Ln,V:re,I:ue,H:se,N:Ge,U:Ve,B:Ke,F:Ye},Tr=Jt.litHtmlPolyfillSupport;Tr?.(Pe,ue),(Jt.litHtmlVersions??=[]).push("3.3.3");var b=(e,t,n)=>{let o=n?.renderBefore??t,s=o._$litPart$;if(s===void 0){let i=n?.renderBefore??null;o._$litPart$=s=new ue(t.insertBefore(Ae(),i),i,void 0,n??{})}return s._$AI(e),s};var Mn=e=>(...t)=>({_$litDirective$:e,values:t}),Ze=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,o){this._$Ct=t,this._$AM=n,this._$Ci=o}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}};var{I:ua}=Jn;var Rr={},Nn=(e,t=Rr)=>e._$AH=t;var Un=Mn(class extends Ze{constructor(){super(...arguments),this.key=c}render(e,t){return this.key=e,t}update(e,[t,n]){return t!==this.key&&(Nn(e),this.key=t),n}});function g(e,t=document){let n=t.querySelector(e);if(!n)throw new Error(`Element not found: ${e}`);return n}function _(e,t=document){return t.querySelector(e)}function pe(e){return Cr.test(e)}var Cr=/^[A-Za-z0-9][A-Za-z0-9._/-]{0,99}$/;function Qe(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function In(e,t){let n=e.split(".").map(Number),o=t.split(".").map(Number);for(let s=0;s<Math.max(n.length,o.length);s+=1){let i=(n[s]??0)-(o[s]??0);if(i!==0)return i}return 0}function zn(e){try{return new URL(e).pathname.replace(/^\/+|\/+$/g,"")||e}catch{return e}}function me(e){return e.replace(/^https?:\/\//,"").replace(/\/$/,"")}function Xe(e){return e.map(t=>({label:t.label,state:t.state,meta:Ar(t.seconds),output:t.output}))}function Ar(e){if(e<60)return`${e}s`;let t=e%60;return t===0?`${Math.floor(e/60)}m`:`${Math.floor(e/60)}m ${t}s`}function R(e,t){let n=Math.max(0,Math.round(Date.now()/1e3)-e),[o,s]=n<60?[n,"second"]:n<3600?[Math.round(n/60),"minute"]:n<86400?[Math.round(n/3600),"hour"]:[Math.round(n/86400),"day"];try{return new Intl.RelativeTimeFormat(t,{numeric:"auto"}).format(-o,s)}catch{return`${o} ${s}`}}function je(e){let t=Math.max(0,Math.round(e));return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function et(e,t){let n=["B","KB","MB","GB","TB"],o=Math.max(0,e),s=0;for(;o>=1024&&s<n.length-1;)o/=1024,s++;return`${new Intl.NumberFormat(t,{maximumFractionDigits:o<10?1:0}).format(o)} ${n[s]}`}function w(e,t){return Un(e,t)}function x(e,t,n,o){let s=document.createElement("sds-button");return s.variant=t,o&&(s.size=o),s.append(document.createTextNode(e)),s.addEventListener("click",n),s}function he(e,t){t.trim()!==""&&e.updateComplete.then(()=>{let n=document.createTreeWalker(e,NodeFilter.SHOW_TEXT).nextNode();if(n){n.nodeValue=t;return}(e.querySelector("button, a")??e).append(document.createTextNode(t))})}function fe(e,t){let n=document.createElement("sds-button"),o=document.createElement("sds-icon");return o.name="actions-window-open",o.size=16,n.variant="secondary",n.href=e,n.rel="external",n.append(document.createTextNode(t),o),n}function Er(e,t,n,o,s){let i=document.createElement("sds-select");return i.options=e.map(d=>({label:d.label,value:d.value,disabled:d.disabled===!0})),i.value=t,i.filled=t!=="",i.label=o,s===void 0?i.size="sm":i.caption=s,i.addEventListener("sds-change",d=>n(d.detail)),i}var Fn=0;function tt(e,t,n,o){if(e.length>6)return Er(e.map(i=>({value:i.value,label:i.label})),t,n,o,o);let s=document.createElement("sds-radio");return Fn+=1,s.name=`choice-${Fn}`,s.legend=o,s.choices=e.map(i=>({label:i.label,value:i.value,...i.hint===void 0?{}:{hint:i.hint}})),s.value=t,s.addEventListener("sds-change",i=>n(i.detail)),s}async function qn(){let e=await fetch("/translations/index.json");return e.ok?await e.json():["en"]}async function Kn(e){let t=await fetch(`/translations/${e}.json`);if(!t.ok)throw new Error(`Missing translations for "${e}"`);return await t.json()}function Gn(e,t,n={}){let o=e[Pr(e,t,n)]??e[t]??t;for(let[s,i]of Object.entries(n))o=o.replaceAll(`{${s}}`,String(i));return o}function Pr(e,t,n){return Number(n.count)===1&&e[`${t}.one`]!==void 0?`${t}.one`:t}var jr="/api",ie=class extends Error{constructor(n,o){super(n);this.status=o}},It=class extends Error{constructor(n){super(`No answer from the container, only a ${n} from in front of it.`);this.status=n}};async function $(e,t={}){let n=t.body?{"Content-Type":"application/json"}:{},o=await fetch(`${jr}/${e}`,{...t,headers:n});if(!o.ok&&Wr(o.status,o.headers.get("Content-Type")))throw new It(o.status);let s=await o.json().catch(()=>({}));if(!o.ok){let i=s.error;throw new ie(i??`Request failed with status ${o.status}`,o.status)}return s}function Wr(e,t){return!((t??"").split(";")[0]?.trim().toLowerCase()==="application/json")&&Hr.includes(e)}var Hr=[404,502,503,504],h={state:()=>$("state"),createWorktree:e=>$("worktrees",{method:"POST",body:JSON.stringify(e)}),preview:e=>$(`worktrees/preview?${new URLSearchParams(e).toString()}`),updateWorktree:(e,t)=>$(`worktrees/${encodeURIComponent(e)}`,{method:"PATCH",body:JSON.stringify(t)}),provisionWorktree:(e,t=!1)=>$(`worktrees/${encodeURIComponent(e)}/provision`,{method:"POST",body:JSON.stringify({fresh:t})}),syncWorktree:(e,t="")=>$(`worktrees/${encodeURIComponent(e)}/sync`,{method:"POST",body:JSON.stringify(t!==""?{from:t}:{})}),pullWorktree:e=>$(`worktrees/${encodeURIComponent(e)}/pull`,{method:"POST"}),commits:(e,t=0)=>$(`worktrees/${encodeURIComponent(e)}/commits${t>0?`?skip=${t}`:""}`),branch:e=>$(`branch?branch=${encodeURIComponent(e)}`),branchCommits:(e,t=0)=>$(`branch/commits?branch=${encodeURIComponent(e)}${t>0?`&skip=${t}`:""}`),commit:(e,t)=>$(`worktrees/${encodeURIComponent(e)}/commits/${encodeURIComponent(t)}`),commitDiff:(e,t,n)=>$(`worktrees/${encodeURIComponent(e)}/commits/${encodeURIComponent(t)}/diff?path=${encodeURIComponent(n)}`),changes:e=>$(`worktrees/${encodeURIComponent(e)}/changes`),worktreeUsage:e=>$(`worktrees/${encodeURIComponent(e)}/usage`),changeDiff:(e,t)=>$(`worktrees/${encodeURIComponent(e)}/changes/diff?path=${encodeURIComponent(t)}`),discardWorktree:e=>$(`worktrees/${encodeURIComponent(e)}/discard`,{method:"POST"}),restoreWorktree:e=>$(`worktrees/${encodeURIComponent(e)}/restore`,{method:"POST"}),removeWorktree:e=>$(`worktrees/${encodeURIComponent(e)}`,{method:"DELETE"}),fetch:e=>$("fetch",{method:"POST",body:JSON.stringify(e!==void 0?{remote:e}:{})}),job:(e,t=0)=>$(`jobs/${encodeURIComponent(e)}${t>0?`?since=${t}`:""}`),worktreeJobs:e=>$(`worktrees/${encodeURIComponent(e)}/jobs`)};function nt(e){try{return localStorage.getItem(e)}catch{return null}}function ot(e,t){try{localStorage.setItem(e,t)}catch{}}function Vn(e,t){return JSON.stringify(e)!==JSON.stringify(t)}function Yn(e){let t=new Set,n=!1,o=()=>{n||(n=!0,requestAnimationFrame(()=>{n=!1;for(let i of t)i()}))};return{state:new Proxy({...e},{set(i,d,u){return Reflect.get(i,d)===u||(Reflect.set(i,d,u),o()),!0}}),subscribe(i){return t.add(i),()=>t.delete(i)}}}var Zn="branchery-language",{state:l,subscribe:rt}=Yn({tld:location.host,projectName:"",worktrees:[],project:null,branch:"",branches:[],remotes:[],repository:null,phpVersions:[],strings:{},loading:!0,language:nt(Zn)||document.documentElement.lang||"en",job:null,runningJobs:[],error:"",unreachable:!1,recipeProblem:null,unconfigured:!1,updateWaiting:!1,exposed:null});function r(e,t={}){return Gn(l.strings,e,t)}async function zt(e){l.strings=await Kn(e),l.language=e,document.documentElement.lang=e,ot(Zn,e),document.querySelectorAll("[data-i18n]").forEach(t=>{let n=t.dataset.i18n;n&&(t.textContent=r(n))})}async function C(e=!1){return We!==null?(e||(l.loading=!0),We):(We=Lr(e).finally(()=>{We=null}),We)}var We=null;async function Lr(e){l.loading=!e;try{let t=await Br();return l.unreachable=!1,t}catch(t){return t instanceof ie?(l.unreachable=!1,L(t.message)):l.unreachable=!0,l.runningJobs}finally{l.loading=!1}}async function Br(){let e=await h.state();return S("worktrees",e.worktrees),S("branches",e.branches),S("remotes",e.remotes),S("repository",e.repository??null),S("branch",e.branch),S("project",e.project),S("phpVersions",e.phpVersions),S("tld",e.tld||location.host),S("projectName",e.projectName??""),S("recipeProblem",e.recipeProblem??null),S("unconfigured",e.unconfigured===!0),S("updateWaiting",e.updateWaiting??!1),S("exposed",e.exposed??null),S("runningJobs",e.runningJobs??[]),l.runningJobs}function S(e,t){Vn(l[e],t)&&(l[e]=t)}function L(e){l.error=e}function j(e){if(Or(e)){l.unreachable=!0;return}L(A(e))}function Or(e){return e instanceof Error&&!(e instanceof ie)}function A(e){return e instanceof ie?e.message:e instanceof Error?r("error.unreachable"):r("error.generic")}function ge(e){let t=l.runningJobs.find(n=>n.subject===e);return t===void 0?void 0:t.step?.label??Kt(t.command)}function Qn(e,t=null,n="create"){let o={id:e,expected:t,kind:n,status:"running",subject:t??"",command:"",step:null,steps:[],elapsed:0,log:"",size:0,partial:!1,interrupted:!1};return l.job=o,o}var qt={"worktree:add":{kind:"create",history:"history.add",doing:"job.doing.create"},"worktree:fork":{kind:"create",history:"history.fork",doing:"job.doing.create"},"worktree:provision":{kind:"create",history:"history.provision",doing:"job.doing.provision"},"worktree:remove":{kind:"remove",history:"history.remove",doing:"job.doing.remove"},"database:sync":{kind:"sync",history:"history.sync",doing:"job.doing.sync"},"worktree:pull":{kind:"pull",history:"history.pull",doing:"job.doing.pull"},"worktree:restore":{kind:"restore",history:"history.restore",doing:"job.doing.restore"},"worktree:discard":{kind:"discard",history:"history.discard",doing:"job.doing.discard"},"git:fetch":{kind:"fetch",history:"history.fetch",doing:"job.doing.fetch"}};function Xn(e){return qt[e]?.kind??"create"}function st(e){return r(qt[e]?.history??"history.other")}function Kt(e){return r(qt[e]?.doing??"job.doing.create")}function it(){return{running:r("step.state.running"),done:r("step.state.done"),failed:r("step.state.failed")}}var to="[A-Za-z0-9][A-Za-z0-9.-]*",Dr=new RegExp(`^/w/(${to})$`),Jr=new RegExp(`^/w/(${to})/c/([0-9a-f]{4,40})$`);function no(e){let t=e.replace(/^#/,""),n=Jr.exec(t);if(n?.[1]!==void 0&&n[2]!==void 0)return{view:"commit",name:n[1],sha:n[2],branch:""};let o=Dr.exec(t);if(o?.[1]!==void 0)return{view:"worktree",name:o[1]};let s=/^\/b\/(.+)\/c\/([0-9a-f]{4,40})$/.exec(t),i=eo(s?.[1]);if(i!==null&&s?.[2]!==void 0)return{view:"commit",name:"",sha:s[2],branch:i};let d=eo(/^\/b\/(.+)$/.exec(t)?.[1]);return d!==null?{view:"branch",name:d}:{view:"overview"}}function eo(e){if(e===void 0||e==="")return null;let t;try{t=decodeURIComponent(e)}catch{return null}return pe(t)?t:null}function q(e,t){return e.view!==t.view?!1:e.view==="worktree"&&t.view==="worktree"||e.view==="branch"&&t.view==="branch"?e.name===t.name:e.view==="commit"&&t.view==="commit"?e.name===t.name&&e.sha===t.sha&&e.branch===t.branch:!0}function Gt(e){return e.replace(/^#/,"").startsWith("new")}function oo(e){return Gt(e)?"#/":null}var ro=[];function B(){return no(window.location.hash)}function at(e){window.location.hash!==`#${e}`&&(window.location.hash=e)}function so(e){ro.push(e)}function io(){history.scrollRestoration="manual"}io();window.addEventListener("hashchange",()=>{io();let e=B();for(let t of ro)t(e)});var lt=globalThis,ct=lt.ShadowRoot&&(lt.ShadyCSS===void 0||lt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,lo=Symbol(),ao=new WeakMap,dt=class{constructor(t,n,o){if(this._$cssResult$=!0,o!==lo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=n}get styleSheet(){let t=this.o,n=this.t;if(ct&&t===void 0){let o=n!==void 0&&n.length===1;o&&(t=ao.get(n)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&ao.set(n,t))}return t}toString(){return this.cssText}},co=e=>new dt(typeof e=="string"?e:e+"",void 0,lo);var uo=(e,t)=>{if(ct)e.adoptedStyleSheets=t.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet);else for(let n of t){let o=document.createElement("style"),s=lt.litNonce;s!==void 0&&o.setAttribute("nonce",s),o.textContent=n.cssText,e.appendChild(o)}},Vt=ct?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let n="";for(let o of t.cssRules)n+=o.cssText;return co(n)})(e):e;var{is:Mr,defineProperty:Nr,getOwnPropertyDescriptor:Ur,getOwnPropertyNames:Fr,getOwnPropertySymbols:Ir,getPrototypeOf:zr}=Object,ut=globalThis,po=ut.trustedTypes,qr=po?po.emptyScript:"",Kr=ut.reactiveElementPolyfillSupport,He=(e,t)=>e,Yt={toAttribute(e,t){switch(t){case Boolean:e=e?qr:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},ho=(e,t)=>!Mr(e,t),mo={attribute:!0,type:String,converter:Yt,reflect:!1,useDefault:!1,hasChanged:ho};Symbol.metadata??=Symbol("metadata"),ut.litPropertyMetadata??=new WeakMap;var F=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,n=mo){if(n.state&&(n.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((n=Object.create(n)).wrapped=!0),this.elementProperties.set(t,n),!n.noAccessor){let o=Symbol(),s=this.getPropertyDescriptor(t,o,n);s!==void 0&&Nr(this.prototype,t,s)}}static getPropertyDescriptor(t,n,o){let{get:s,set:i}=Ur(this.prototype,t)??{get(){return this[n]},set(d){this[n]=d}};return{get:s,set(d){let u=s?.call(this);i?.call(this,d),this.requestUpdate(t,u,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??mo}static _$Ei(){if(this.hasOwnProperty(He("elementProperties")))return;let t=zr(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(He("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(He("properties"))){let n=this.properties,o=[...Fr(n),...Ir(n)];for(let s of o)this.createProperty(s,n[s])}let t=this[Symbol.metadata];if(t!==null){let n=litPropertyMetadata.get(t);if(n!==void 0)for(let[o,s]of n)this.elementProperties.set(o,s)}this._$Eh=new Map;for(let[n,o]of this.elementProperties){let s=this._$Eu(n,o);s!==void 0&&this._$Eh.set(s,n)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let n=[];if(Array.isArray(t)){let o=new Set(t.flat(1/0).reverse());for(let s of o)n.unshift(Vt(s))}else t!==void 0&&n.push(Vt(t));return n}static _$Eu(t,n){let o=n.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,n=this.constructor.elementProperties;for(let o of n.keys())this.hasOwnProperty(o)&&(t.set(o,this[o]),delete this[o]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return uo(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,n,o){this._$AK(t,o)}_$ET(t,n){let o=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,o);if(s!==void 0&&o.reflect===!0){let i=(o.converter?.toAttribute!==void 0?o.converter:Yt).toAttribute(n,o.type);this._$Em=t,i==null?this.removeAttribute(s):this.setAttribute(s,i),this._$Em=null}}_$AK(t,n){let o=this.constructor,s=o._$Eh.get(t);if(s!==void 0&&this._$Em!==s){let i=o.getPropertyOptions(s),d=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:Yt;this._$Em=s;let u=d.fromAttribute(n,i.type);this[s]=u??this._$Ej?.get(s)??u,this._$Em=null}}requestUpdate(t,n,o,s=!1,i){if(t!==void 0){let d=this.constructor;if(s===!1&&(i=this[t]),o??=d.getPropertyOptions(t),!((o.hasChanged??ho)(i,n)||o.useDefault&&o.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(d._$Eu(t,o))))return;this.C(t,n,o)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,n,{useDefault:o,reflect:s,wrapped:i},d){o&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,d??n??this[t]),i!==!0||d!==void 0)||(this._$AL.has(t)||(this.hasUpdated||o||(n=void 0),this._$AL.set(t,n)),s===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(n){Promise.reject(n)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,i]of this._$Ep)this[s]=i;this._$Ep=void 0}let o=this.constructor.elementProperties;if(o.size>0)for(let[s,i]of o){let{wrapped:d}=i,u=this[s];d!==!0||this._$AL.has(s)||u===void 0||this.C(s,void 0,i,u)}}let t=!1,n=this._$AL;try{t=this.shouldUpdate(n),t?(this.willUpdate(n),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(n)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(n)}willUpdate(t){}_$AE(t){this._$EO?.forEach(n=>n.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(n=>this._$ET(n,this[n])),this._$EM()}updated(t){}firstUpdated(t){}};F.elementStyles=[],F.shadowRootOptions={mode:"open"},F[He("elementProperties")]=new Map,F[He("finalized")]=new Map,Kr?.({ReactiveElement:F}),(ut.reactiveElementVersions??=[]).push("2.1.2");var Zt=globalThis,be=class extends F{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let n=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=b(n,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return oe}};be._$litElement$=!0,be.finalized=!0,Zt.litElementHydrateSupport?.({LitElement:be});var Gr=Zt.litElementPolyfillSupport;Gr?.({LitElement:be});(Zt.litElementVersions??=[]).push("4.2.2");var Vr=new Set(["worktree:add","worktree:fork"]);function fo(e,t){let n=new Set(t);return e.filter(o=>Vr.has(o.command)&&o.subject!==""&&!n.has(o.subject))}function pt(e,t){return e.filter(n=>mt([n.name,n.branch,n.database,n.url,n.php,n.base?.branch??"",n.tip?.subject??""].join(" "),t))}function go(e,t){return e.filter(n=>mt([n.name,n.tip?.subject??""].join(" "),t))}function mt(e,t){let n=t.toLowerCase().split(/\s+/).filter(s=>s!==""),o=e.toLowerCase();return n.every(s=>o.includes(s))}function bo(e,t){let n=o=>o.base===null?[0,""]:o.base.branch===t?[1,""]:[2,o.base.branch];return e.map((o,s)=>({worktree:o,at:s,rank:n(o)})).sort((o,s)=>o.rank[0]-s.rank[0]||o.rank[1].localeCompare(s.rank[1],void 0,{numeric:!0})||o.at-s.at).map(o=>o.worktree)}function yo(){let e=!1;return{pending:()=>e,run(t,n=()=>{}){if(e)return!1;e=!0;let o=()=>{e=!1,n()},s;try{s=t()}catch(i){throw o(),i}return Promise.resolve(s).then(o,o),!0}}}var O=g("#wizard"),Yr=g("#wizForm"),ye=g("#wizProgress"),$o=g("#wizTitle"),ft=g("#wizLead"),ht=g("#wizBody"),Zr=g("#wizFoot"),Qt=g("#wizBack"),$e=g("#wizNext"),k=null,T=0,Le=!1,Qr=yo(),Xr={update:()=>en()};function K(e){k=e,T=0,Le=!1,vo(e.tall===!0),Xt(),gt()}function vo(e){O.classList.toggle("sds-modal--lg",e),O.classList.toggle("sds-modal--md",!e)}function gt(){O.open||O.showModal()}function D(){O.open&&O.close()}function ae(){return O.open}function bt(){return O.open&&k!==null}function yt(e){O.addEventListener("close",e)}function $t(){return k===null?[]:k.steps.filter(e=>e.when===void 0||e.when())}function vt(){$t()[T]?.leave?.()}function Xt(){let e=$t(),t=e[T];t&&($o.textContent=t.heading,b(t.lead??c,ft),ft.hidden=t.lead===void 0,es(e),b(c,ht),t.enter(ht,Xr),en(),window.setTimeout(()=>{_('input:not([type]), input[type="text"]',ht)?.focus()},20))}function es(e){ye.hidden=e.length<2,!(e.length<2)&&(ye.caption=e[T]?.label??"",ye.label=r("step.progress"),ye.max=e.length,ye.value=T+1)}function en(){let e=$t(),t=e[T];if(!t||k===null)return;let n=T===e.length-1;tn({back:T===0?r("action.cancel"):r("action.back"),onBack:ts,next:n?k.finishLabel():r("action.next"),onNext:wo}),$e.disabled=t.ready?.()===!1}function wo(){let e=$t(),t=e[T];if(!(!t||k===null||t.ready?.()===!1)){if(T>=e.length-1){let n=k;Qr.run(()=>n.finish(),()=>{k===n&&!Le&&en()})&&($e.disabled=!0);return}vt(),T+=1,Xt()}}function ts(){if(T===0){D();return}vt(),T-=1,Xt()}Yr.addEventListener("submit",e=>{e.preventDefault(),k!==null&&wo()});O.addEventListener("close",()=>{vt(),k=null,Le=!1});function tn(e={}){Zr.hidden=e.back==null&&e.next==null,Qt.hidden=e.back==null,he(Qt,e.back??""),Qt.onclick=e.onBack??null,$e.hidden=e.next==null,he($e,e.next??""),$e.disabled=!1,$e.onclick=e.onNext??null}function wt(e,t=""){Le||(Le=!0,k===null&&vo(!1)),vt(),k=null,ye.hidden=!0,$o.textContent=e,b(t===""?c:t,ft),ft.hidden=t===""}function _o(e){b(e,ht)}function J(){return a`
        ...
        style="--sds-skeleton-delay: ${e%3*.12}s"></span>`}var xo=null,on=new Map,nn=new Set,ns=300,rn;function sn(e){return e!==""&&!pe(e)?r("error.branchName"):""}function ko(e){return e===l.branch||l.project?.branch===e||l.branches.some(t=>t.name===e)||l.worktrees.some(t=>t.branch===e)}function So(e){let t=sn(e);return t!==""?t:e!==""&&ko(e)?r("error.branchExists",{branch:e}):""}function G(e,t=""){let n={mode:l.branches.length>0?"branch":"fork",branch:t,from:"",name:""},o=()=>n.name.trim()||Qe(n.branch),s=()=>{let d=o();return d!==""&&d===l.projectName?r("preview.isProject",{name:d}):l.worktrees.some(u=>u.name===d)?r("preview.exists",{name:d}):""},i={tall:!0,steps:[os(n),ss(n),as(n,o,s)],finishLabel:()=>n.mode==="fork"?r("action.fork"):r("action.create"),finish:()=>ds(n,o(),e)};K(i)}function os(e){return{label:r("step.mode.label"),heading:r("step.mode.heading"),lead:r("step.mode.lead"),ready:()=>e.mode==="fork"||pe(e.branch),enter(t,n){let o=l.branches.length>0;o||(e.mode="fork");let s=()=>{b(a`
                    <sds-radio
        ...
        <button type="button" class="branchery-picklist__item"
                ...
                @click=${()=>{e.branch=i,t()}}>${i}</button>`)}function ss(e){return{label:r("step.fork.label"),heading:r("step.fork.heading"),lead:r("step.fork.lead"),when:()=>e.mode==="fork",ready:()=>pe(e.branch)&&!ko(e.branch),enter(t,n){let o=()=>{b(a`
                    ${""}
                    <sds-field
                        field-id="newBranch"
        ...
        <div class="branchery-preview">
            <dl>
                ...
                <dd><code class="sds-mono">https://${Qe(t())}.${l.tld}</code></dd>
        ...
        <sds-field
            ...
            value=${e.name===""?Qe(e.branch):e.name}
            ?filled=${e.name!==""}
            @sds-input=${m=>{e.name=m.detail.trim(),Be(e,t,n,o,s),ls(e,t,n,o,s)}}></sds-field>
        ${p===""?c:a`<sds-note tone="error" body=${p}></sds-note>`}`,o),s.update()}async function ds(e,t,n){let o=e.mode==="fork"?{mode:"fork",branch:e.branch,from:e.from,name:e.name}:{mode:"branch",branch:e.branch,name:e.name};try{let s=await h.createWorktree(o);n.onJob(s.job,t)}catch(s){j(s),_("#name")!==null&&xo?.(A(s))}}function _t(e){return e.filter(t=>!t.isProject&&(t.merged||t.gone)&&t.changes===0)}function Co(e){return e.merged}function Ao(e,t){let n=_t(e),o=new Set(n.filter(Co).map(s=>s.name));K({tall:n.length>3,steps:[{label:r("tidy.step"),heading:r("tidy.heading"),lead:r("tidy.lead"),enter(s,i){b(a`
                    <sds-checkbox-group
                        ...
                        .values=${[...o]}
                        @sds-change=${d=>{o.clear();for(let u of d.detail)o.add(u);i.update()}}></sds-checkbox-group>`,s)},ready:()=>o.size>0}],finishLabel:()=>r("tidy.confirm",{count:o.size}),finish:()=>us(n.filter(s=>o.has(s.name)),t)})}function cs(e){return e.merged?r("tidy.why.merged"):r("tidy.why.gone")}async function us(e,t){wt(r("tidy.working"),r("tidy.workingLead",{count:e.length}));let n=await Promise.allSettled(e.map(i=>h.removeWorktree(i.name))),o=[];n.forEach((i,d)=>{let u=e[d]?.name??"";i.status==="fulfilled"?o.push({job:i.value.job,name:u}):j(i.reason)});let s=o[0];if(s===void 0){D();return}t.onJob(s.job,s.name,"remove")}var ps=6,E="",Eo=10,an=!1,le=null;function dn(e){le=e,l.loading||xs();let t=bs(),n=bo(pt(l.worktrees,E),l.project?.branch??l.branch);b(a`
      <div class="sds-bands">
        ...
        <section class="sds-band sds-band--quiet">
            <div class="branchery-section-head">
                ${t.length+l.branches.length>=ps?ys():c}
        ...
        ${Hs()}
      </div>`,g("#main"))}function ms(){return l.repository!==null?zn(l.repository):l.projectName===""?r("nav.worktrees"):l.projectName}function hs(){return l.loading&&l.repository===null&&l.projectName===""}function fs(e,t){let n=_t(e);return n.length===0||l.loading?c:a`
        <sds-note tone="info"
        ...
        <sds-note tone="warn"
                  body=${r("overview.unfinished",{count:t.length,names:jo(t)})}></sds-note>`}function jo(e){return e.map(t=>t.name).join(", ")}function bs(){return l.project?[l.project,...l.worktrees]:l.worktrees}function ys(){return a`
        <sds-field
            ...
            @keydown=${$s}></sds-field>`}function Wo(e){E=e,Ho()}function Ho(){le!==null&&dn(le)}function $s(e){if(e.key==="Escape"){e.target instanceof HTMLElement&&e.target.blur(),Wo("");return}if(e.key==="Enter"){let t=pt(l.worktrees,E)[0]??pt(l.project===null?[]:[l.project],E)[0];t!==void 0&&(e.preventDefault(),at(`/w/${t.name}`))}}var ln=null;function vs(){let e=JSON.stringify([l.remotes,l.language]);if(ln?.key!==e){let t=Os();ln={key:e,nodes:[...t===null?[]:[t],ws()]}}return ln.nodes}function St(e){le!==null&&e(le)}function ws(){let e=x(r("nav.newWorktree"),"primary",()=>St(G));return e.title=`${r("nav.newWorktree")} (n)`,e}function _s(e,t){if(l.unreachable&&e.length===0)return c;let n=fo(l.runningJobs,e.map(s=>s.name)).filter(s=>mt(s.subject,E)),o=E.trim()===""?r("table.empty"):r("overview.noMatch");return!l.loading&&t.length===0&&n.length===0?a`<p class="branchery-list__empty">${o}</p>`:a`
        <sds-table
            ?loading=${l.loading}
            loading-rows=${Ss()}
            ...
            .rows=${l.loading?[]:[...n.map(ks),...t.map(Ts)]}></sds-table>`}var Lo="branchery-rows";function Ss(){let e=l.worktrees.length;if(e>0)return e;let t=Number(nt(Lo));return Number.isFinite(t)&&t>0?t:1}function xs(){ot(Lo,String(l.worktrees.length))}function ks(e){return{cells:[{value:a`<span class="branchery-list__title">${e.subject}</span>`,note:cn(`${r("table.making")} \xB7 ${e.step?.label??Kt(e.command)}`)},"","",""]}}function cn(e){return a`<span class="branchery-list__meta--busy"><sds-icon
                    class="sds-spinner" name="actions-circle-half" size="em"
                    aria-hidden="true"></sds-icon>${e}</span>`}function Ts(e){let t=ge(e.name);return{cells:[{value:a`<a class="branchery-list__title" href="#/w/${e.name}">${e.name}</a>${t!==void 0?c:Bo(e)}`,note:t===void 0?Do(e):cn(t)},Ds(e),e.php,Rs(e)]}}function Rs(e){return a`
        ...
        </div>`}var Mo=25;function xt(e){let t=e.files.length-Mo,n=e.all||t<=0?e.files:e.files.slice(0,Mo);return a`
...
`).reverse().find(n=>n.startsWith(Io));return t===void 0?"":t.slice(Io.length).trim()}var Io="\u2717";function qo(e){let t={php:e.php},n=()=>{let s=[];return t.php!==e.php&&s.push({label:r("table.php"),value:t.php,note:r("edit.effect.php")}),s},o={steps:[Ys(e,t),Zs(e,n)],finishLabel:()=>r("action.apply"),finish:()=>Qs(e,t)};K(o)}function Ys(e,t){return{label:r("table.php"),heading:r("edit.step.php.heading",{name:e.name}),lead:r("edit.step.php.lead"),ready:()=>t.php!==e.php,enter(n,o){let s=l.phpVersions.filter(i=>i===e.php||e.minPhp===null||In(i,e.minPhp)>=0);b(a`${tt(s.map(i=>({value:i,label:i,...i===e.php?{hint:r("edit.current")}:{}})),t.php,i=>{t.php=i,o.update()},r("table.php"))}`,n)}}}function Zs(e,t){return{label:r("step.review.label"),heading:r("edit.step.review.heading",{name:e.name}),lead:r("step.review.lead"),enter(n){b(a`
        ...
        </p>`}function Et(e,t,n){let o=fn("");async function s(i,d){d>0&&o.name===i&&(o={...o,reading:!0,trouble:""},n()),await t(()=>e(i,d),()=>o.name===i,(u,p)=>{let f=d>0?o.commits?.commits??[]:[];o={name:i,commits:u===null?o.commits:{...u,commits:[...f,...u.commits]},trouble:p,reading:!1}})}return{about(i){o.name!==i&&(o=fn(i),s(i,0))},of:i=>o.name===i?o.commits:null,trouble:i=>o.name===i&&o.commits===null&&o.trouble!==""?`${r("detail.commitsFailed")} ${o.trouble}`:"",body(i,d){let u=o.name===i?o.commits:null;return u===null?ei():a`${ti(u,d)}
                ${oi(u,o.trouble,o.reading,()=>void s(i,u.commits.length))}`},forget(i){o.name===i&&(o=fn(""))}}}function fn(e){return{name:e,commits:null,trouble:"",reading:!1}}function Pt(e){return e.facts.length===0?c:a`
        <div class="sds-facts-group">
            <p class="sds-label">${e.title}</p>
            <dl class="sds-facts">${e.facts.map(ri)}</dl>
        </div>`}function ri(e,t){return a`
        <dt>${e.label}</dt>
        <dd>${e.waiting===!0?W(t):e.copy===!0?a`<sds-copy value=${e.value} label=${e.label}></sds-copy>`:e.said===!0?e.value:a`<code class="sds-mono">${e.value}</code>`}</dd>`}function jt(e){return[e.own>0?r("detail.ownCommits",{count:e.own}):r("detail.ownNone"),...e.moved>0?[r("table.baseMoved",{base:e.branch,count:e.moved})]:[]].join(" \xB7 ")}var De={user:"admin",password:"Password1!"};function Go(e,t){return[{title:r("detail.repository"),facts:[{label:r("table.branch"),value:e.branch},...gn(e)?[{label:r("detail.madeFor"),value:e.madeFor??""}]:[],...e.base!==null?[{label:r("detail.base"),value:e.forkedAt!==null&&e.forkedFrom===e.base.branch?`${e.base.branch} @ ${e.forkedAt.slice(0,11)}`:e.base.branch},{label:r("detail.sinceBase"),value:jt(e.base),said:!0}]:[],{label:r("detail.commits"),value:ii(e),said:!0},{label:r("detail.changes"),value:e.changes>0?r("table.changes",{count:e.changes}):r("detail.clean"),said:!0},...e.builtAt===null?[]:[{label:r("detail.built"),value:R(e.builtAt,l.language),said:!0}]]},{title:r("table.address"),facts:[{label:r("detail.site"),value:me(e.url),copy:!0},...e.backend===null?[]:[{label:r("detail.backend"),value:me(e.backend),copy:!0}]]},{title:r("detail.serving"),facts:[{label:r("table.php"),value:e.php+(e.minPhp!==null&&e.minPhp!==e.php?` (${r("detail.minPhp",{version:e.minPhp})})`:"")},...e.node===null?[]:[{label:r("table.node"),value:e.node}],{label:r("table.profile"),value:e.profile??r("table.noProfile")},{label:r("table.docroot"),value:e.docroot===""?"/":e.docroot}]},{title:r("detail.taken"),facts:[{label:r("table.directory"),value:e.path,copy:!0},{label:r("table.database"),value:e.database,copy:!0},...e.backend===null?[]:[{label:r("detail.user"),value:De.user,copy:!0},{label:r("detail.password"),value:De.password,copy:!0}]]},...e.isProject?[]:[si(e.name,t)]]}function si(e,t){return t.name===e&&t.trouble!==""?{title:r("detail.storage"),facts:[{label:r("detail.storageTotal"),value:`${r("detail.storageFailed")} ${t.trouble}`,said:!0}]}:t.name!==e||t.value===null?{title:r("detail.storage"),facts:[{label:r("detail.storageTotal"),value:"",waiting:!0},{label:r("detail.storageFiles"),value:"",waiting:!0},{label:r("detail.storageDatabase"),value:"",waiting:!0},{label:r("detail.storageShared"),value:r("detail.storageExcluded"),said:!0}]}:{title:r("detail.storage"),facts:[{label:r("detail.storageTotal"),value:et(t.value.total,l.language),said:!0},{label:r("detail.storageFiles"),value:et(t.value.files,l.language),said:!0},{label:r("detail.storageDatabase"),value:et(t.value.database,l.language),said:!0},{label:r("detail.storageShared"),value:r("detail.storageExcluded"),said:!0}]}}function ii(e){if(e.gone)return r("table.gone");if(e.ahead===null||e.behind===null)return r("detail.noRemote");let t=[...e.ahead>0?[r("table.unpushed",{count:e.ahead})]:[],...e.behind>0?[r("table.behind",{count:e.behind})]:[]];return t.length===0?r("detail.inStep"):t.join(" \xB7 ")}function gn(e){return e.madeFor!==null&&e.madeFor!==e.branch}var de=g("#changes"),bn="";function Vo(){return bn}function Yo(e,t,n){bn=e,de.heading=t,de.body=n,de.actions=[a`${w(r("action.close"),a`<sds-button variant="ghost" @click=${()=>de.close()}>${r("action.close")}</sds-button>`)}`],de.show()}function Zo(){de.close()}function Qo(e){de.addEventListener("sds-dialog-cancel",()=>{bn="",e()})}var we=g("#confirm");function Wt(e){return we.heading=e.title,we.body=ai(e),we.confirmLabel=e.confirmLabel,we.cancelLabel=r("action.cancel"),we.tone=e.tone??"primary",we.ask()}function ai(e){return a`
        <p>${e.message}</p>
        ...
        ${e.facts===void 0||e.facts.length===0?c:a`
            ...
            </div>`}`}async function Xo(e,t){await Wt({title:r("confirm.sync.title"),message:r("confirm.sync.body"),facts:[{label:r("table.worktree"),value:e.name},{label:r("table.database"),value:e.database},{label:r("confirm.source"),value:r("field.branchFromProject",{branch:l.project?.branch??l.branch})}],confirmLabel:r("action.sync")})&&await _e(()=>h.syncWorktree(e.name),e.name,"sync",t)}function li(e){return[...e.ahead===null?[r("confirm.worktree.nowhere")]:[],...e.ahead!==null&&e.ahead>0?[r("confirm.worktree.unpushed",{count:e.ahead})]:[],...e.changes>0?[r("confirm.worktree.changes",{count:e.changes})]:[]]}async function er(e,t,n){let o=n;if(o===null)try{o=await h.commits(e.name)}catch(u){j(u);return}let s=o.commits.filter(u=>!u.pushed),i=o.upstream??e.branch;await Wt({title:r("confirm.discard.title"),message:r("confirm.discard.body",{upstream:i}),...(e.behind??0)>0?{warning:r("confirm.discard.behind",{count:e.behind??0})}:{},facts:s.map(u=>({label:u.sha,value:u.subject})),confirmLabel:r("action.discard"),tone:"danger"})&&await _e(()=>h.discardWorktree(e.name),e.name,"discard",t)}async function tr(e,t){await _e(()=>h.restoreWorktree(e.name),e.name,"restore",t)}async function nr(e,t){await _e(()=>h.pullWorktree(e.name),e.name,"pull",t)}async function Ht(e,t,n){await _e(()=>h.provisionWorktree(e,t),e,"create",n)}async function or(e,t){let n=li(e);await Wt({title:r("confirm.worktree.title"),message:r("confirm.worktree.body"),...n.length>0?{warning:n.join(" ")}:{},facts:[{label:r("table.worktree"),value:e.name},{label:r("table.branch"),value:e.branch},{label:r("table.database"),value:e.database}],confirmLabel:r("action.remove"),tone:"danger"})&&await _e(()=>h.removeWorktree(e.name),null,"remove",t)&&at("/")}async function _e(e,t,n,o){try{let s=await e();return L(""),o.onJob(s.job,t,n),!0}catch(s){return j(s),await C(),!1}}function Lt(e,t){let n={fresh:!1},o={steps:[di(e,n)],finishLabel:()=>n.fresh?r("provision.fresh"):r("table.provision"),finish:()=>t(n.fresh)};K(o)}function di(e,t){return{label:r("table.database"),heading:r("provision.heading",{name:e.name}),lead:r("provision.lead"),enter(n,o){b(a`${tt([{value:"keep",label:r("provision.keep"),hint:r("provision.keepHint")},{value:"fresh",label:r("provision.fresh"),hint:r("provision.freshHint")}],t.fresh?"fresh":"keep",s=>{t.fresh=s==="fresh",o.update()},r("table.database"))}`,n)}}}var P={name:"",entries:null,trouble:""},Y=new Map,yn=new Set,Me=ve(A,Z),xe=Et((e,t)=>h.commits(e,t),Me,Z),y=$n(""),ce={name:"",value:null,trouble:""};function $n(e){return{name:e,list:{read:null,trouble:"",open:!1},all:!1,diffs:new Map}}var V=null;function rr(){V=null,Zo()}function ci(e){return V?.name===e&&q(B(),{view:"worktree",name:e})}function sr(e){if(P.name===e&&(P={name:"",entries:null,trouble:""},Y.clear()),xe.forget(e),y.name===e){let t=Vo()===e;y=$n(t?e:""),t&&(y.list.open=!0,ir(e))}ce.name===e&&(ce={name:"",value:null,trouble:""}),V?.name===e&&Z()}function vn(e,t){V={name:e,handlers:t};let n=[l.project,...l.worktrees].find(s=>s?.name===e)??null;P.name!==e&&(P={name:e,entries:null,trouble:""},Y.clear(),Ri(e));let o=n?.incomplete===!0?ar():null;o!==null&&!Y.has(o.id)&&lr(o.id),n!==null&&xe.about(e),n!==null&&!n.isProject&&ce.name!==e&&(ce={name:e,value:null,trouble:""},Ci(e)),b(n===null?ui(e):pi(n,t),g("#main")),y.name===e&&y.list.open&&Yo(e,r("table.uncommitted"),bi(e))}function ui(e){return!l.loading&&!l.unreachable?a`
          <div class="sds-page">
      ...
      <div class="sds-bands">
        <section class="sds-band">
            ...
            ${e.stale&&n===void 0?$i(e,t):c}
        </section>

        <section class="sds-band sds-band--quiet">
            <h2 class="sds-h3">${r("detail.settled")}</h2>
            <div class="sds-facts-set">${Go(e,ce).map(Pt)}</div>
        </section>
      ...
      </div>`}function Je(e,t){return e===null?c:a`${fe(e,t)}`}function mi(e){let t=xe.of(e.name),n=xe.trouble(e.name);return n!==""?a`
            <section class="sds-band">
        ...
        <section class="sds-band">
            ...
            ${xe.body(e.name,o=>`#/w/${encodeURIComponent(e.name)}/c/${o}`)}
        </section>`}function hi(e){return a` ${w(r("detail.showFiles"),a`<sds-button variant="ghost" @click=${()=>fi(e)}>${r("detail.showFiles")}</sds-button>`)}`}function fi(e){y.name!==e&&(y=$n(e)),y.list.open=!0,y.list.read===null&&ir(e),Z()}Qo(()=>{y.list.open=!1,Z()});function gi(e,t){y.name===e&&(kt(y.diffs,t,()=>void yi(e,t)),Z())}function bi(e){let t=y.list;return t.trouble!==""?a`<sds-note tone="warn" body=${`${r("detail.changesFailed")} ${t.trouble}`}></sds-note>`:t.read===null?J():xt({files:t.read,diffs:y.diffs,press:n=>gi(e,n),all:y.all,showAll:()=>{y.all=!0,Z()}})}async function ir(e){await Me(async()=>(await h.changes(e)).changes,()=>y.name===e,(t,n)=>{y.list={...y.list,read:t,trouble:n}})}async function yi(e,t){await Me(()=>h.changeDiff(e,t),()=>y.name===e&&y.diffs.has(t),(n,o)=>Tt(y.diffs,t,n,o))}function $i(e,t){return a`
        <sds-note
            tone="warn"
            heading=${r("detail.staleHeading")}
            body=${r("detail.stale")}
            action=${r("table.provision")}
            @sds-note-action=${()=>Lt(e,n=>Ht(e.name,n,t))}></sds-note>`}function vi(e,t){let n=ar(),o=n===null?null:Y.get(n.id)?.stopped??null;return a`
        <sds-note
            tone="warn"
            ...
            action=${r("table.provision")}
            @sds-note-action=${()=>Lt(e,s=>Ht(e.name,s,t))}></sds-note>`}function ar(){return P.entries?.find(e=>e.status==="failed")??null}function wi(e){return a`
        <sds-note
            tone="info"
        ...
        </section>`}var Se=null;function Si(e,t){let n=x(r("table.discard"),"danger",()=>void er(e,t,xe.of(e.name))),o=x(r("table.remove"),"danger",()=>void or(e,t)),s=new Set;e.changes>0&&(s.add(n),n.title=r("detail.discardBlocked"));let i=x(r("table.pull"),"secondary",()=>void nr(e,t));e.behind===0&&(s.add(i),i.title=r("detail.pullBlocked"));let u=[...gn(e)?[x(r("table.restore",{branch:e.madeFor??""}),"secondary",()=>void tr(e,t))]:e.behind===null?[]:[i],x(r("table.edit"),"secondary",()=>qo(e)),x(r("table.sync"),"secondary",()=>void Xo(e,t)),x(r("table.provision"),"secondary",()=>Lt(e,f=>Ht(e.name,f,t)))],p=[...(e.ahead??0)>0?[n]:[],o];return{doing:u,undoing:p,held:s}}function xi(){return P.trouble!==""?a`<sds-note tone="warn" body=${`${r("detail.historyFailed")} ${P.trouble}`}></sds-note>`:P.entries===null?J():P.entries.length===0?a`<p class="branchery-list__quiet">${r("detail.noHistory")}</p>`:a`<div class="branchery-history">${P.entries.map(ki)}</div>`}function ki(e){let t=Y.get(e.id),n=`${R(e.started,l.language)} \xB7 ${je(e.elapsed)}`;return a`
        <sds-run
            heading=${st(e.command)}
            verdict=${e.status}
            note=${t!==void 0&&t.trouble!==""?`${n} \xB7 ${t.trouble}`:n}
            .stateWords=${it()}
            .steps=${t?.steps??[]}
            @click=${o=>Ti(o,e.id)}></sds-run>`}function Ti(e,t){let n=e.target;!(n instanceof Element)||!n.closest(".sds-run__head")||Y.get(t)?.settled===!0||lr(t)}async function Ri(e){await Me(()=>h.worktreeJobs(e),()=>P.name===e,(t,n)=>{P={name:e,entries:t,trouble:n}})}async function Ci(e){await Me(()=>h.worktreeUsage(e),()=>ce.name===e,(t,n)=>{ce={name:e,value:t,trouble:n}})}async function lr(e){if(!yn.has(e)){yn.add(e);try{let t=await h.job(e),n=t.status==="unknown"&&t.steps.length===0;Y.set(e,{steps:Xe(Ct(Rt,t).steps),trouble:n?r("detail.noLog"):"",settled:!0,stopped:Ai(t)})}catch(t){Y.set(e,{steps:[],trouble:`${r("detail.logFailed")} ${A(t)}`,settled:!1,stopped:null})}finally{yn.delete(e)}Z()}}function Ai(e){let t=e.steps.find(n=>n.state==="failed");return e.status!=="failed"||t===void 0?null:{no:t.no,step:t.label,reason:At(e.log)}}function Z(){V!==null&&ci(V.name)&&vn(V.name,V.handlers)}var Ne=null,Q={name:"",branch:null,trouble:""},dr=ve(A,ur),wn=Et((e,t)=>h.branchCommits(e,t),dr,ur);function cr(){Ne=null}function Sn(e,t){Ne=e,Q.name!==e&&(Q={name:e,branch:null,trouble:""},Oi(e)),wn.about(e),b(Ei(e,t),g("#main"))}var _n=null;function ur(){Ne!==null&&_n!==null&&q(B(),{view:"branch",name:Ne})&&Sn(Ne,_n)}function Ei(e,t){_n=t;let n=Q.branch;return a`
      <div class="sds-bands">
        <section class="sds-band">
            ${l.error===""?c:a`<sds-note tone="error" body=${l.error}></sds-note>`}
            ${I(r("detail.back"),"#/")}
        ...
        ${n===null?c:a`
            <section class="sds-band sds-band--quiet">
                <h2 class="sds-h3">${r("detail.settled")}</h2>
                <div class="sds-facts-set">${Hi(n).map(Pt)}</div>
            </section>`}
        ...
        </div>`}function Hi(e){return[{title:r("detail.repository"),facts:[...e.base===null?[]:[{label:r("detail.base"),value:e.base.branch},{label:r("detail.sinceBase"),value:jt(e.base),said:!0}],{label:r("detail.commits"),value:Li(e),said:!0},{label:r("detail.moved"),value:R(e.when,l.language),said:!0}]}]}function Li(e){if(e.gone)return r("table.gone");if(e.upstream===null)return e.onRemote?r("detail.onRemoteOnly"):r("detail.noRemote");let t=[...e.ahead!==null&&e.ahead>0?[r("table.unpushed",{count:e.ahead})]:[],...e.behind!==null&&e.behind>0?[r("table.behind",{count:e.behind})]:[]];return t.length===0?r("detail.inStep"):`${e.upstream} \xB7 ${t.join(" \xB7 ")}`}function Bi(e){let t=wn.trouble(e);return a`
        <section class="sds-band">
            <h2 class="sds-h3">${r("detail.commitsHeading")}</h2>
            ${t===""?wn.body(e,n=>`#/b/${encodeURIComponent(e)}/c/${n}`):a`<sds-note tone="warn" body=${t}></sds-note>`}
        </section>`}async function Oi(e){await dr(()=>h.branch(e),()=>Q.name===e,(t,n)=>{Q={name:e,branch:t,trouble:n}})}var Di={schedule:(e,t)=>setTimeout(e,t),cancel:e=>clearTimeout(e)};function pr(e,t,n,o=Di){let s=!1,i=null,d=()=>{i=o.schedule(()=>{i=null,u()},n)},u=async()=>{let p;try{p=await e()}catch{s||d();return}s||(t(p)?d():s=!0)};return u(),()=>{s=!0,i!==null&&(o.cancel(i),i=null)}}var Ji=1e3,xn=0,mr=null,Tn=null;function Rn(e,t,n,o,s=!0){let i=++xn;mr?.();let d=Qn(e,t,n??"create"),u=s,p=Rt,f=()=>{u&&!bt()&&hr(d)};Tn=()=>{u=!0,gt(),hr(d)},s&&Tn();let v=async()=>{await C(),i===xn&&(l.job=d,f(),o(d))};mr=pr(()=>h.job(e,p.size),m=>i!==xn?!1:(p=Ct(p,m),d={...m,log:p.log,steps:p.steps,expected:t??(m.subject===""?null:m.subject),kind:n??Xn(m.command)},m.status==="running"?(f(),!0):(v(),!1)),Ji)}var Mi={running:"job.running",done:"job.ticket.done",failed:"job.ticket.failed",unknown:"job.ticket.unknown"},X=null,kn="";function Bt(){let e=l.job!==null&&!ae()?l.job.status:"",t=Mi[e];if(t===void 0){X?.remove(),X=null,kn="";return}X!==null&&kn===e||(X?.remove(),kn=e,X=x(r(t),"secondary",()=>{(Tn??gt)(),Bt()}),X.className=`branchery-ticket branchery-ticket--${e}`,X.title=r("job.show"),document.body.append(X))}yt(()=>Bt());rt(()=>Bt());function hr(e){wt(Fi(e),e.status==="running"?"":zi(e)),_o(a`
        <sds-run open
                 heading=${Ui(e)}
                 verdict=${e.status}
                 note=${Ii(e)}
                 .stateWords=${it()}
                 .steps=${Xe(e.steps)}></sds-run>`),Ni(e),Bt()}function Ni(e){tn(e.status==="running"?{back:r("action.leaveRunning"),onBack:()=>D()}:{back:r("action.copyLog"),onBack:()=>void qi(e),next:r("action.close"),onNext:()=>{l.job=null,D()}})}function Ui(e){return r(zo(e.status))}function Fi(e){return e.expected??(e.subject===""?st(e.command):e.subject)}function Ii(e){let t=je(e.elapsed);return e.status==="running"?e.step===null?t:`${r("job.stepOf",{no:e.step.no,total:e.step.total})} \xB7 ${t}`:e.status==="failed"?e.interrupted?r("job.interrupted"):At(e.log)||t:hn(e.status)?t:""}function zi(e){if(!hn(e.status))return"";let t=je(e.elapsed);if(e.kind==="fetch"){let s=e.log.split(`
`).filter(i=>i.includes(" -> ")).length;return s===0?r("job.done.fetch",{time:t}):r("job.done.fetchMoved",{count:s,time:t})}let n=l.worktrees.find(s=>s.name===e.expected);if(!n||e.kind==="remove")return r(`job.done.${e.kind}`,{name:e.expected??"",time:t});let o=e.kind==="sync"?r("job.done.sync",{name:n.database}):e.kind==="pull"?r("job.done.pull",{branch:n.branch}):e.kind==="restore"?r("job.done.restore",{branch:n.branch}):e.kind==="discard"?r("job.done.discard",{branch:n.branch}):n.backend===null?r("job.done.built",{php:n.php}):`${r("job.done.built",{php:n.php})} ${r("job.login",De)}`;return a`
        ...
        <sds-link external href=${n.url}
                  label=${r("action.openWorktree")}></sds-link>`}async function qi(e){let t=_("#wizBack");try{await navigator.clipboard.writeText(e.log.trim()),t&&(he(t,r("action.copied")),window.setTimeout(()=>he(t,r("action.copyLog")),2e3))}catch{}}var Ot={onJob(e,t=null,n=null){Rn(e,t,n,yr)}};function yr(e){let t=e.expected??e.subject;t!==""&&sr(t)}function Fe(e,t,n,o){let s=g(e);if(s.hidden=!t,!t)return;let i=s.firstElementChild;i===null&&(i=document.createElement("sds-note"),o!==void 0&&i.addEventListener("sds-note-action",o),s.append(i));for(let[d,u]of Object.entries(n()))i.setAttribute(d,u)}function Ki(){Fe("#offline",l.unreachable,()=>({tone:"warn",body:r("error.unreachable"),action:r("action.tryAgain")}),()=>void C())}function Gi(){Fe("#update",l.updateWaiting,()=>({tone:"info",heading:r("update.waiting"),body:r("update.how")}))}function Vi(){let e=l.exposed;Fe("#exposed",e!==null,()=>({tone:"warn",heading:r("exposed.heading"),body:r(e==="router"?"exposed.router":"exposed.container")}))}function Yi(){Fe("#unconfigured",l.unconfigured,()=>({tone:"info",heading:r("error.unconfigured"),body:r("error.unconfiguredHow")}))}function Zi(){let e=l.recipeProblem;Fe("#recipe",e!==null,()=>({tone:"warn",heading:r("error.recipe"),body:e??""}))}var ke=B();function Re(e=B()){if(ae())return;let t=e.view!==ke.view,n=!q(e,ke);n&&window.scrollTo(0,0),t&&(ke.view==="worktree"&&rr(),ke.view==="commit"&&Uo(),ke.view==="branch"&&cr()),ke=e,$r(),Ki(),Vi(),Gi(),sa(),Zi(),Yi(),Qi(e),n&&Xi()}function Qi(e){if(e.view==="worktree"){vn(e.name,Ot);return}if(e.view==="branch"){Sn(e.name,Ot);return}if(e.view==="commit"){pn(e.name,e.sha,e.branch);return}dn(Ot)}function Xi(){g("#main").focus({preventScroll:!0})}rt(()=>Re());so(e=>{L(""),Re(e)});var Te=g("#bar"),Ue=[],ea="https://benjaminkott.github.io/ddev-branchery/",fr="";function $r(){fr!==l.language&&(fr=l.language,Te.menu={label:r("app.title"),items:[{label:r("nav.worktrees"),href:"#/",current:!0},{label:r("nav.docs"),href:ea,external:!0}]})}function vr(){Te.product=r("app.title"),$r()}function wr(){Te.languages=Ue.map(e=>({label:ta(e),current:e===l.language,lang:e})),Te.updateComplete.then(()=>{_(".sds-bar__lang",Te)?.setAttribute("name",r("app.language"))})}function ta(e){try{return new Intl.DisplayNames([e],{type:"language"}).of(e)??e.toUpperCase()}catch{return e.toUpperCase()}}Te.addEventListener("sds-dropdown-choose",e=>{let t=Ue[e.detail.index];!t||t===l.language||zt(t).then(()=>{wr(),vr(),Re()})});g("#wizard").addEventListener("close",()=>{l.job?.status!=="running"&&(l.job=null)});yt(()=>{let e=oo(location.hash);e!==null&&history.replaceState(null,"",e),Re(),C(!0)});var na=5e3,gr=Date.now();async function _r(){let e=Date.now();document.visibilityState!=="visible"||l.job?.status==="running"||ae()||e-gr<na||(gr=e,Sr(await C(!0)))}function Sr(e){let t=e[0];t!==void 0&&l.job?.status!=="running"&&Rn(t.id,null,null,yr,!1)}var oa=2e3,ra=1e4,br=!1;function sa(){if(br)return;br=!0;let e=()=>{let t=l.runningJobs.length>0||ae()||l.unreachable;window.setTimeout(()=>{if(document.visibilityState!=="visible"||ae()){e();return}C(!0).then(e)},t?oa:ra)};e()}document.addEventListener("visibilitychange",()=>void _r());window.addEventListener("focus",()=>void _r());function xr(){if(Gt(location.hash)){G(Ot);return}bt()&&D()}window.addEventListener("hashchange",xr);(async()=>(Ue=await qn(),await zt(Ue.includes(l.language)?l.language:Ue[0]??"en"),wr(),vr(),Re(),Sr(await C()),Re(),xr()))();
