...
final class ExampleCommand extends Command
{
    ...
    private function example(?string $name, array $names): string
    {
        ...
        return sprintf(
            ...
            . "# Everything written here stands over it. In a moment,\n"
            . "# \"inherit: profile\" is where that file does its own work; left out,\n"
            . "# the moment is what stands here and no more.\n"
            . "profile: %1\$s\n"
            . "\n"
